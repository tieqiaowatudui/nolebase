...
其中 Script Filter + Run Script相同的地方,都是可以接受参数,并且执行脚本.在当前任务的区别中,Script Filter可以将执行完成后的结果以列表的形式输出,然后展示在Alfred 窗口中.提供选择.Script Filter提供了一个交互的场景.Run Script的功能主要是执行一个参数.更详细的查看
